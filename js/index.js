// Register GSAP plugins
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            const disableScrub = prefersReducedMotion || isMobile;
            ...
            if (!disableScrub) {
                ...
                // Modo fluido (Mobile ou Reduzido): damos play no vídeo e atualizamos apenas os textos no scroll
                video.loop = true;
                video.play().catch(e => console.log("Autoplay impedido:", e));
                
                // Continua desenhando o vídeo em loop no canvas para garantir performance máxima
                gsap.ticker.add(() => {
                ...
                // Mantém o efeito de opacidade e scroll dos textos mesmo sem o scrub do vídeo
                ScrollTrigger.create({
                    trigger: ".hero-track",
                    start: "top top",
                    end: "bottom bottom",
